   ...
   <div class="container-fluid pt-5 mb-3">
       <div class="container">
           ...
           <div class="owl-carousel news-carousel carousel-item-4 position-relative">
                   @php
                       $postsssss = App\Models\Post::all();
                   @endphp
               @foreach ($postsssss as $poste)
               <div class="position-relative overflow-hidden" style="height: 300px;">
                       <div class="position-relative overflow-hidden" style="height: 300px;">
                           <img class="img-fluid h-100" src="{{ asset($poste->image) }}"
                           ...
                           <div class="overlay">
                               ...
                               <div class="mb-2">
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">
                                    {{ str_replace(['<p>', '</p>'], '', $poste->meta_description) }}
                                </a>
                               </div>
                           ...
                           <div class="position-relative mb-3">
                               ...
                               <div class="bg-white border border-top-0 p-4">
                                   ...
                                   <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold"
                                       href="">{{$post->description}}</a>
                                   <p class="m-0">{{ str_replace(['<p>', '</p>'], '', $poste->meta_description) }}</p>
                               </div>


                               <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                   <div class="d-flex align-items-center">
                                       <img class="rounded-circle mr-2" src="{{ asset($post->image) }}"
                   ...
                   <div class="mb-3">
                       ...
                       <div class="bg-white text-center border border-top-0 p-3">
                           <a href=""><img class="img-fluid"
                                   src="{{ asset('frontend') }}/img/news-800x500-2.jpg" alt=""></a>
                       </div>
                   </div>
                   <!-- Ads End -->
                   ...
                   <div class="mb-3">
                       ...
                       <div class="bg-white border border-top-0 p-3">
                           <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                               <img class="img-fluid" src="{{ asset('frontend') }}/img/news-110x110-1.jpg"
                                   alt="">
                               <div
                           ...
                           <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                               <img class="img-fluid" src="{{ asset('frontend') }}/img/news-110x110-2.jpg"
                                   alt="">
                               <div
                                   class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                   <div class="mb-2">
                           ...
                           <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                               <img class="img-fluid" src="{{ asset('frontend') }}/img/news-110x110-3.jpg"
                                   alt="">
                               <div
                                   class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                   <div class="mb-2">
                           ...
                           <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                               <img class="img-fluid" src="{{ asset('frontend') }}/img/news-110x110-4.jpg"
                                   alt="">
                               <div
                                   class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                   <div class="mb-2">
                           ...
                           <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                               <img class="img-fluid" src="{{ asset('frontend') }}/img/news-110x110-5.jpg"
                                   alt="">
                               <div
                                   class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                   <div class="mb-2">
