    ...
    <div class="container-fluid d-none d-lg-block">
        ...
        <div class="row align-items-center bg-white py-3 px-lg-5">
            ...
            <div class="col-lg-8 text-center text-lg-right">
                <a href="https://htmlcodex.com"><img class="img-fluid" src="{{ asset('frontend') }}/img/ads-728x90.png"
                        alt=""></a>
            </div>
        </div>
    </div>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                ...
                @endphp
                    ...
                    <a href="" class="nav-item nav-link" value="{{ $category->id }}">{{ $category->name }}</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="#" class="nav-link dropdown-toggle" value="{{ $category->id }}"
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            @foreach ($subcategories as $subcategory)
                                <a href="{{ url('subcategory/' . $subcategory->id) }}" class="dropdown-item">
                                    {{ $subcategory->name }}
                                </a>
                            @endforeach
